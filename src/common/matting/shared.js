...
export default class Shared {
  ...
  setImage(oriUrl) {
    this.loadImage(oriUrl, (img) => {
      console.log('inputImg',img,img.width,img.height);
      document.getElementById('test_ori').src=oriUrl;
      let gl = this.gl;
  ...
  setTrimap(triUrl) {
    this.loadImage(triUrl, (img) => {
      console.log('trimap',img,img.width,img.height);
      document.getElementById('test_tri').src=triUrl;
      let gl = this.gl;
